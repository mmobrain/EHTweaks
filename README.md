...
## Contributors
*   **Xurkon:** Multiple fixes
*   **MedianAura:** Feature - Hide minimap button, Feature - display a warning on screen when you die that warn you to check permanent echo before respawning.
