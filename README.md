...
### 🪄 Smart Tooltips
*   **Rank Merging**: For skills with multiple ranks, the browser combines values into a single view (e.g., "Deals |cff00ff0010/20/30|r damage") so you can see the full progression at a glance.
