...
local function RefreshData()
    ...
    if browserFrame and browserFrame.countLabel then
        local count = #filteredData -- Use filtered count or total? User image shows "Total Skills: 301" which might be total.
        -- Actually, let's use the explicit counts calculated above
        if activeTab == 1 then
